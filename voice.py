...
def setup_assistant_voice(ttsEngine, assistant):
    """
...
def record_and_recognize_audio(*args: tuple, recognizer, microphone, assistant):
    """
...
setup_assistant_voice(ttsEngine, assistant)
...
while True:
    ...
    voice_input = record_and_recognize_audio(recognizer=recognizer,microphone=microphone, assistant=assistant)
