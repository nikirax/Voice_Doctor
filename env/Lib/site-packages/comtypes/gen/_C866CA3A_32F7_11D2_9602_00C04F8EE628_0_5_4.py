...
__all__ = [
    'SAFT8kHz8BitMono', 'SGSExclusive', 'DISPID_SLGetWords',
    'ISpeechObjectTokenCategory', 'DISPID_SPEActualConfidence',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechPhraseAlternates', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPPId', 'SpInprocRecognizer', 'DISPID_SOTsItem',
    'SAFT44kHz16BitMono', 'ISpeechGrammarRuleStateTransition',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechTokenValueCLSID', 'SLTApp',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRSTsItem',
    'SPFM_OPEN_READWRITE', 'SVEStartInputStream', 'DISPID_SOTId',
    'SVP_1', 'DISPID_SWFEAvgBytesPerSec', 'SRADefaultToActive',
    'SP_VISEME_19', 'SpResourceManager', 'SPPS_RESERVED3',
    'SPEI_UNDEFINED', 'STCInprocServer', 'ISpeechAudio', 'SpVoice',
    'SREFalseRecognition', 'SREPrivate', 'SPPHRASE',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCEFalseRecognition',
    'SpObjectTokenCategory', 'SRSEIsSpeaking', 'ISpObjectWithToken',
    'SECFIgnoreWidth', 'SAFT8kHz8BitStereo', 'ISpeechDataKey',
    'SPWORDPRONOUNCEABLE', 'ISpPhoneConverter',
    'SpeechDisplayAttributes', 'DISPID_SWFEFormatTag',
    'DISPID_SVSCurrentStreamNumber', 'SpeechAudioFormatGUIDText',
    'SPGRAMMARWORDTYPE', 'SPAS_PAUSE', 'SVESentenceBoundary',
    'SPEI_TTS_PRIVATE', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRProfile',
    'DISPID_SPPs_NewEnum', 'SPPHRASEELEMENT',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPBINARYGRAMMAR',
    'ISpeechPhraseProperties', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGCmdLoadFromObject', 'SPPS_Modifier', 'SPPS_Noncontent',
    'DISPID_SRCESoundStart', 'SAFT16kHz16BitMono', 'SVSFIsNotXML',
    'DISPID_SVEViseme', 'DISPID_SDKCreateKey', 'SPVPRI_ALERT',
    'DISPID_SPEDisplayText', 'SPSEMANTICFORMAT',
    'SpeechCategoryAppLexicons', 'SPDKL_DefaultLocation',
    'DISPID_SPCLangId', 'DISPID_SOTRemoveStorageFileName',
    'SDTAlternates', 'SPSHT_NotOverriden', 'DISPID_SPPParent',
    'SAFT12kHz8BitMono', 'DISPID_SABufferNotifySize', 'SP_VISEME_0',
    'DISPID_SPRuleName', 'DISPID_SWFEBitsPerSample',
    'SpeechTokenKeyFiles', 'SAFT12kHz16BitStereo', 'SVSFVoiceMask',
    'SBOPause', 'DISPID_SpeechLexiconProns', 'SSTTWildcard',
    'DISPID_SPIReplacements', 'SPWF_INPUT', 'SRTEmulated',
    'DISPID_SVEAudioLevel', 'SLODynamic', 'SpeechRecoEvents',
    'DISPID_SRGetFormat', 'DISPID_SABIBufferSize', 'SpeechAudioState',
    'DISPID_SLWWord', 'ISpeechLexiconPronunciation', 'SP_VISEME_1',
    'SVP_5', 'SPWORDPRONUNCIATIONLIST', 'ISpeechGrammarRule',
    'DISPID_SGRs_NewEnum', 'ISpRecoContext',
    'DISPID_SpeechVoiceEvent', 'SPPROPERTYINFO',
    'DISPID_SPEAudioSizeBytes', 'SVEBookmark', 'SP_VISEME_3',
    'IEnumString', 'SpeechRuleAttributes',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVESentenceBoundary',
    'SPEI_RESERVED2', 'DISPID_SGRsFindRule', 'SRAExport', 'SITooLoud',
    'DISPID_SpeechPhraseElements', 'ISpDataKey', 'SP_VISEME_7',
    'ISpMMSysAudio', 'DISPID_SRGDictationSetState',
    '_RemotableHandle', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SDKGetBinaryValue', 'DISPID_SOTs_NewEnum',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_SOUND_END',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechRecoContext', 'SAFTADPCM_22kHzMono',
    'ISpResourceManager', 'SPAS_RUN', 'SDTAll', 'DISPID_SPPsItem',
    'SVP_6', 'Speech_Max_Word_Length', 'DISPID_SRGIsPronounceable',
    'DISPID_SGRsCount', 'SPBO_PAUSE', 'DISPID_SPILanguageId',
    'SpeechEmulationCompareFlags', 'SPEVENTENUM',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_21',
    'SPEI_SR_BOOKMARK', 'SDKLCurrentUser',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVGetProfiles',
    'SPAR_Medium', 'DISPID_SRRRecoContext', 'SAFTADPCM_11kHzStereo',
    'DISPIDSPTSI_ActiveLength', 'SPSHORTCUTPAIRLIST', 'SP_VISEME_10',
    'DISPID_SDKSetStringValue', 'ISpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE7', 'SAFT22kHz8BitMono', 'DISPID_SRCBookmark',
    'ISpeechPhraseInfoBuilder', 'SAFTADPCM_8kHzStereo', 'SpStream',
    'SITooSlow', 'SPBO_NONE', 'SREHypothesis',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCPause',
    'SpeechVoiceSpeakFlags', 'SPADAPTATIONRELEVANCE',
    'SpeechVoiceCategoryTTSRate', '_ISpeechRecoContextEvents',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCResume', 'SPEI_PHONEME',
    'DISPID_SRState', 'ISpeechAudioBufferInfo', 'SINoSignal',
    'SAFT48kHz16BitMono', 'DISPID_SVEStreamEnd',
    'DISPID_SPPEngineConfidence', 'SAFT24kHz16BitMono',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_RESERVED7', 'SECFDefault',
    'DISPID_SRCAudioInInterferenceStatus', 'SPCS_DISABLED',
    'SPWORDPRONUNCIATION', 'SPBOOKMARKOPTIONS', 'DISPID_SPRuleParent',
    'SVSFParseSapi', 'SpStreamFormatConverter',
    'ISpeechPhoneConverter', 'ISpeechPhraseReplacement',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SP_VISEME_16',
    'SPVPRIORITY', 'ISpeechBaseStream', 'DISPID_SpeechGrammarRules',
    'SITooFast', 'DISPID_SLPsItem', 'DISPID_SPIGetText',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRSTType',
    'SPWT_LEXICAL', 'SPAR_High', 'DISPID_SPEDisplayAttributes',
    'SAFT48kHz16BitStereo', 'ISpRecognizer3', 'DISPID_SGRsCommit',
    'DISPID_SRCreateRecoContext', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRAudioFormat', 'DISPID_SVEPhoneme',
    'DISPID_SPRNumberOfElements', 'SAFT32kHz8BitMono',
    'SPEI_TTS_BOOKMARK', 'SPDKL_LocalMachine',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpRecognizer2',
    'DISPID_SpeechVoiceStatus', 'SGRSTTEpsilon', 'DISPID_SPIEngineId',
    'SP_VISEME_17', 'DISPIDSPTSI', 'ISpeechPhraseRules',
    'ISpPhraseAlt', 'eLEXTYPE_PRIVATE20', 'SPWAVEFORMATTYPE',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechMicTraining',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRGRules',
    'DISPID_SRCEStartStream', 'ISpeechWaveFormatEx',
    'SpeechGrammarState', 'SDKLLocalMachine', 'ISpNotifyTranslator',
    'eLEXTYPE_APP', 'DISPID_SPPChildren', 'SRTSMLTimeout',
    'SECFIgnoreKanaType', 'DISPID_SPPConfidence',
    'SAFTGSM610_8kHzMono', 'ISpeechRecoGrammar', 'ISpRecoGrammar',
    'SAFTGSM610_44kHzMono', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SOTRemove',
    'SPPS_RESERVED4', 'SPFM_OPEN_READONLY', 'SPEI_VOICE_CHANGE',
    'DISPID_SRAudioInput', 'SVF_Stressed', 'DISPID_SLGenerationId',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechRecoResult',
    'DISPID_SVSInputWordLength', 'SPSVerb', 'DISPID_SpeechMMSysAudio',
    'SpMMAudioEnum', 'SVP_4', 'SpeechTokenKeyUI', 'DISPID_SRGReset',
    'DISPID_SPIRule', 'DISPID_SGRSTPropertyValue',
    'SSFMOpenReadWrite', 'IInternetSecurityMgrSite', 'SPSHT_Unknown',
    'SpeechRecognizerState', 'SAFT11kHz8BitMono', 'ISpShortcut',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE16',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRSTPropertyName',
    'eWORDTYPE_ADDED', 'DISPID_SRGCmdLoadFromMemory',
    'SPEI_RESERVED6', 'DISPID_SPRs_NewEnum', 'ISpeechLexicon',
    'SAFT11kHz8BitStereo', 'DISPID_SVResume', 'SVP_9',
    'DISPID_SAEventHandle', 'ISpeechPhraseProperty', 'SREPhraseStart',
    'SVSFParseAutodetect', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechFileStream', 'SPGS_DISABLED', 'SPRECOSTATE',
    'SAFTExtendedAudioFormat', 'DISPID_SPEPronunciation',
    'SP_VISEME_12', 'SPRECOGNIZERSTATUS', 'SAFT48kHz8BitStereo',
    'SPRULE', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTGetDescription', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCEHypothesis', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechLexicon', 'SVP_18',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRCVoice',
    'DISPID_SpeechAudioBufferInfo', 'SpeechVoiceEvents',
    'DISPID_SLRemovePronunciation',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechPropertyComplexResponseSpeed', 'SpeechEngineProperties',
    'SVEAudioLevel', 'SPLO_STATIC', 'ISpLexicon',
    'DISPID_SGRsDynamic', 'DISPID_SpeechLexiconPronunciation',
    'SGDSInactive', 'DISPID_SPAStartElementInResult', 'SPEI_MIN_SR',
    'SAFTText', 'SREInterference', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechVoice', 'SPRST_INACTIVE', 'ISpEventSource',
    'DISPID_SPPFirstElement', 'SpFileStream',
    ...
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_TTS_AUDIO_LEVEL', 'SVP_17',
    'DISPID_SpeechWaveFormatEx', 'SPPS_RESERVED1', 'SPPS_LMA',
    'SPEI_INTERFERENCE', 'SRARoot', 'SPSMF_UPS', 'SPAO_NONE',
    'SPAO_RETAIN_AUDIO', 'DISPID_SGRSTPropertyId', 'DISPID_SLWType',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechAudio',
    'SPCT_SUB_DICTATION', 'SpeechPropertyResponseSpeed',
    'DISPID_SRRecognizer', 'SPSHT_EMAIL', 'DISPID_SGRSRule',
    'SSFMCreate', 'DISPID_SPRulesItem', 'SpeechTokenKeyAttributes',
    'DISPID_SPEs_NewEnum', 'DISPID_SRSCurrentStreamPosition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRCEEndStream',
    'SREStateChange', 'SpUnCompressedLexicon', 'SDKLCurrentConfig',
    'SPPS_Noun', 'SVEAllEvents', 'ISpRecoGrammar2',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVEventInterests',
    'DISPID_SGRSTs_NewEnum', 'SECLowConfidence', 'SpeechAllElements',
    'SpCompressedLexicon', 'DISPID_SFSClose',
    'DISPID_SOTCEnumerateTokens', 'SPAS_CLOSED',
    'DISPID_SpeechRecognizer', 'DISPID_SGRsAdd',
    'ISpeechCustomStream', 'SPEI_WORD_BOUNDARY', 'SVEVoiceChange',
    'SPSHORTCUTPAIR', 'SGDSActiveUserDelimited',
    'SPSEMANTICERRORINFO', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVSRunningState', 'DISPID_SRRGetXMLErrorInfo', 'SASRun',
    'SVP_11', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_6',
    'SPEI_HYPOTHESIS', 'SpeechSpecialTransitionType',
    'SWPUnknownWordUnpronounceable', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPBO_TIME_UNITS', 'DISPID_SPIElements',
    'DISPID_SpeechCustomStream', 'SPDATAKEYLOCATION',
    'DISPIDSPTSI_ActiveOffset', 'SpMMAudioIn', 'SAFT22kHz8BitStereo',
    ...
    'DISPID_SpeechRecoContextEvents', 'SVF_Emphasis', 'SPEI_MAX_SR',
    'SGLexicalNoSpecialChars', 'SPEI_FALSE_RECOGNITION',
    'ISequentialStream', 'SREPropertyStringChange',
    'DISPID_SWFEBlockAlign', 'SGDSActive', 'SPCT_SLEEP',
    'SpSharedRecognizer', 'DISPID_SPAsCount',
    'DISPID_SRGetPropertyString', 'ISpPhrase',
    'ISpeechRecoResultTimes', 'DISPID_SRSetPropertyString',
    'SAFTADPCM_8kHzMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpRecoResult', 'DISPID_SRRPhraseInfo',
    'DISPID_SRGSetTextSelection', 'DISPIDSPRG',
    'DISPID_SGRSTNextState', '_SPAUDIOSTATE',
    'ISpeechPhraseAlternate', 'DISPID_SOTDataKey',
    'DISPID_SPIProperties', 'SAFT8kHz16BitStereo',
    'ISpeechGrammarRules', 'SRAORetainAudio',
    'SAFTCCITT_ALaw_22kHzMono', 'SPAUDIOSTATE',
    'SAFTCCITT_uLaw_44kHzMono', 'IStream', 'SpeechWordType', 'SVP_19',
    'SPPS_Unknown', 'SPLEXICONTYPE', 'SVEEndInputStream',
    'SPSHORTCUTTYPE', 'ISpObjectTokenCategory', 'SpeechInterference',
    'DISPID_SpeechRecoResult2', 'SpeechAudioVolume',
    'SPEVENTSOURCEINFO', 'SpInProcRecoContext', 'ISpVoice',
    'DISPID_SLPLangId', 'DISPID_SVSLastBookmark',
    'SpeechGrammarTagWildcard', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCEAudioLevel',
    'ISpeechRecoResult', 'DISPID_SVPause', 'SVP_12',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpAudio', 'SPAUDIOSTATUS',
    'SPCT_COMMAND', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechGrammarRuleStateTransitionType', 'SVSFIsXML',
    'DISPID_SASCurrentDevicePosition', 'SRESoundEnd',
    'DISPID_SGRClear', 'DISPID_SLWsCount', 'ISpeechPhraseInfo',
    'DISPID_SRGCmdSetRuleState', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPANumberOfElementsInResult', 'SpeechCategoryVoices',
    'SAFT32kHz16BitStereo', 'SVEWordBoundary',
    'DISPID_SOTGetAttribute', 'DISPID_SWFEChannels',
    'DISPID_SGRSTransitions', 'DISPID_SMSADeviceId',
    'DISPID_SRGCommit', 'SSSPTRelativeToEnd', 'DISPID_SPRuleId',
    'SpPhoneticAlphabetConverter', 'SVP_8', 'DISPID_SOTCDefault',
    'ISpeechRecoContext', 'DISPID_SPEsCount', 'SPWORDTYPE',
    'SPFM_CREATE_ALWAYS', 'SVSFParseSsml', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhoneConverter', 'DISPID_SOTDisplayUI',
    'SP_VISEME_8', 'DISPID_SVWaitUntilDone', 'SpeechVisemeType',
    'SVP_21', 'SPEI_MAX_TTS', 'DISPID_SLGetGenerationChange',
    'DISPID_SOTGetStorageFileName', 'ISpStream',
    'DISPID_SVSInputWordPosition', 'SpeechUserTraining',
    'DISPID_SRCRequestedUIType', 'ISpeechLexiconPronunciations',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_4',
    'DISPID_SRCCreateGrammar', 'DISPID_SVSLastResult', 'SPBO_AHEAD',
    'SSFMOpenForRead', 'SpeechTokenShellFolder', 'SP_VISEME_14',
    'eLEXTYPE_PRIVATE18', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRCEventInterests', 'SRERecognition', 'SRAONone',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVAudioOutputStream',
    'IEnumSpObjectTokens', 'SpeechLoadOption',
    'DISPID_SRAudioInputStream', 'DISPID_SAFType', 'UINT_PTR',
    'SPGS_ENABLED', 'SVPAlert', 'SpeechAudioFormatType', 'SASStop',
    'ISpeechPhraseElement', 'SPTEXTSELECTIONINFO', 'SPVOICESTATUS',
    'ISpRecognizer', 'SAFT24kHz8BitStereo', 'SRTStandard', 'SVP_13',
    'DISPID_SVSLastBookmarkId', 'tagSPPROPERTYINFO',
    'DISPID_SRRTLength', 'DISPID_SABufferInfo', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechGrammarRuleState', 'SPRS_ACTIVE', 'SVSFParseMask',
    'SpeechCategoryAudioOut', 'DISPID_SOTIsUISupported',
    'SAFT44kHz8BitMono', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPEsItem', 'DISPID_SRRAlternates',
    'SWPUnknownWordPronounceable', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechPhraseProperties', 'SPCONTEXTSTATE',
    'DISPID_SPCPhoneToId', 'ISpeechPhraseReplacements',
    'SREStreamStart', 'DISPID_SpeechObjectTokens', 'SVEViseme',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechRecognizerStatus',
    'SpeechAudioProperties', 'SpNullPhoneConverter',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_2', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPRuleConfidence', 'SVEPhoneme', 'SAFT8kHz16BitMono',
    'SPXMLRESULTOPTIONS', 'DISPID_SDKEnumKeys',
    'DISPID_SPRuleNumberOfElements', 'SpeechRecoContextState',
    'DISPID_SVVoice', 'DISPID_SABIEventBias',
    'DISPIDSPTSI_SelectionLength', 'SAFT44kHz16BitStereo',
    'DISPID_SMSSetData', 'DISPID_SOTSetId', 'ISpNotifySource',
    'DISPID_SRCRecognizer', 'DISPID_SFSOpen', 'SVSFNLPMask',
    'SpObjectToken', 'DISPID_SVEStreamStart',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechPhraseProperty', 'eLEXTYPE_RESERVED10',
    'SPFILEMODE', 'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE11',
    'SDTReplacement', 'ISpRecoCategory', 'DISPID_SRCEBookmark',
    'ISpeechRecognizer', 'SVP_10', 'SPWORD', 'SAFT12kHz16BitMono',
    'SGRSTTTextBuffer', 'DISPID_SGRId', 'STSF_LocalAppData',
    'DISPID_SRGDictationUnload', 'SAFT22kHz16BitMono',
    'SPCT_SUB_COMMAND', 'SVSFlagsAsync', 'SVP_3',
    'DISPID_SpeechPhraseRules', 'SVP_14', 'SpPhraseInfoBuilder',
    'SRCS_Disabled', 'DISPID_SpeechLexiconWords', 'SFTSREngine',
    'SWPKnownWordPronounceable', 'DISPID_SVSpeak',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE14', 'SASClosed',
    'SPEI_END_INPUT_STREAM', 'SRSInactive', 'DISPID_SASNonBlockingIO',
    'DISPID_SVEBookmark', 'SPEI_VISEME', 'SpNotifyTranslator',
    'SPDKL_CurrentConfig', 'SGRSTTWord',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechGrammarRuleState',
    'DISPID_SREmulateRecognition', 'SAFT24kHz16BitStereo',
    'SPSInterjection', 'DISPID_SGRSTRule',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLWPronunciations',
    'SP_VISEME_18', 'SPINTERFERENCE_TOOLOUD', 'SPAR_Unknown',
    'SECFEmulateResult', 'DISPID_SPRText', 'DISPID_SPRulesCount',
    'SpeechDiscardType', 'SVP_15', 'DISPID_SPPNumberOfElements',
    'DISPID_SRStatus', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRRSpeakAudio', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechTokenContext',
    'DISPID_SVPriority', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SRSInactiveWithPurge', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRCRetainedAudio', 'SINoise', 'SVP_16',
    'SPPHRASEREPLACEMENT', 'SVSFNLPSpeakPunc',
    'DISPID_SGRInitialState', 'DISPID_SBSFormat', 'DISPID_SBSRead',
    'DISPID_SLPPhoneIds', 'DISPID_SPPValue', 'SPCATEGORYTYPE',
    'SPCT_DICTATION', 'IInternetSecurityManager', 'DISPID_SPACommit',
    'DISPID_SRCEPhraseStart', 'SPPS_RESERVED2', 'DISPID_SPCIdToPhone',
    'SRCS_Enabled', 'SPINTERFERENCE_NONE', 'SPEI_RESERVED1',
    'SpTextSelectionInformation', 'SAFTDefault', 'SWTDeleted',
    'SpeechGrammarTagDictation', 'SpeechRunState',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE12',
    'SPPS_NotOverriden', 'SRATopLevel', 'DISPID_SVRate',
    'DISPID_SVEWord', 'SINone', 'SDA_No_Trailing_Space', 'SPSNoun',
    'DISPID_SRCERecognition', 'eLEXTYPE_PRIVATE13', 'DISPID_SASState',
    'SSSPTRelativeToStart', 'SpPhoneConverter',
    'DISPID_SRSAudioStatus', 'SPRULESTATE', 'DISPID_SOTCategory',
    'SVSFPersistXML', 'SVP_0', 'DISPID_SRCRetainedAudioFormat',
    'SGPronounciation', 'SPGS_EXCLUSIVE', 'SPEI_RECO_OTHER_CONTEXT',
    'SGRSTTDictation', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SMSALineId', 'DISPID_SDKSetBinaryValue',
    'SpeechDictationTopicSpelling', 'DISPID_SDKGetlongValue',
    'SDTProperty', 'DISPID_SpeechPhraseRule',
    'SDA_Two_Trailing_Spaces', 'DISPID_SABIMinNotification',
    'STSF_CommonAppData', 'ISpRecoContext2', 'SPRST_NUM_STATES',
    'SAFT44kHz8BitStereo', 'SSSPTRelativeToCurrentPosition',
    'SPSFunction', 'SPRECORESULTTIMES', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SGRAddState', 'SPLOADOPTIONS', 'SAFT16kHz8BitMono',
    'SPSNotOverriden', 'ISpeechAudioFormat',
    'DISPID_SRCEInterference', 'DISPID_SPISaveToMemory',
    'ISpStreamFormatConverter', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechObjectTokens', 'SpeechPropertyHighConfidenceThreshold',
    'SPSHT_OTHER', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SP_VISEME_5', 'DISPID_SMSGetData', 'SPEI_END_SR_STREAM',
    'SGRSTTWildcard', 'SpLexicon', 'eLEXTYPE_PRIVATE4',
    'SPEI_START_SR_STREAM', 'ISpeechLexiconWords', 'SPVISEMES',
    'DISPID_SRIsShared', 'DISPID_SOTsCount', 'ISpGrammarBuilder',
    'DISPID_SRRSaveToMemory', 'SpeechPartOfSpeech',
    'DISPID_SGRAddResource', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseReplacement', 'SPFM_CREATE',
    'DISPID_SpeechLexiconWord', 'DISPID_SRCEAdaptation',
    'SpeechCategoryRecognizers', 'DISPID_SGRSTsCount', 'SP_VISEME_20',
    'SRAInterpreter', 'DISPID_SRCState', 'SPEI_START_INPUT_STREAM',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechDataKey',
    'DISPID_SRRSetTextFeedback', 'SpAudioFormat',
    'ISpeechPhraseElements', 'ISpStreamFormat',
    'SAFTADPCM_22kHzStereo', 'SVSFPurgeBeforeSpeak',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_RESERVED9',
    ...
    'SPAR_Low', 'ISpeechPhraseRule', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPPName', 'SAFT32kHz8BitStereo', 'SPEI_RESERVED3',
    'DISPID_SPAs_NewEnum', 'SPDKL_CurrentUser', 'eLEXTYPE_RESERVED4',
    'DISPID_SVVolume', 'DISPID_SRGetRecognizers',
    'SAFT12kHz8BitStereo', 'tagSPTEXTSELECTIONINFO', 'SBONone',
    'SITooQuiet', 'SECHighConfidence', 'SPSERIALIZEDRESULT',
    'SDTPronunciation', 'DISPID_SPAsItem', 'DISPID_SRRTimes',
    'SREAdaptation', 'DISPID_SVEEnginePrivate', 'SVP_7',
    'SpWaveFormatEx', 'LONG_PTR', 'SpSharedRecoContext',
    'DISPID_SOTMatchesAttributes', 'DISPID_SPELexicalForm',
    'SAFT32kHz16BitMono', 'SWTAdded', 'SVSFUnusedFlags',
    'DISPID_SVGetVoices', 'DISPID_SLWsItem', 'SAFTNonStandardFormat',
    'DISPID_SVAudioOutput', 'SGDSActiveWithAutoPause',
    '_ISpeechVoiceEvents', 'SSTTTextBuffer', 'SDTRule',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPRsCount',
    'SRERequestUI', 'DISPID_SGRSTWeight', 'DISPID_SRGState',
    'SpShortcut', 'DISPID_SRRAudio', 'SpeechVisemeFeature',
    'ISpSerializeState', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SDKDeleteValue', 'DISPID_SPRuleFirstElement',
    'DISPID_SVIsUISupported', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPPHRASERULE', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SPPsCount',
    'SREAudioLevel', 'SPWORDLIST', 'SRSActiveAlways', 'SpMMAudioOut',
    'DISPID_SRCESoundEnd', 'SAFT22kHz16BitStereo', 'SVP_20',
    'SPEI_PHRASE_START', 'SpeechRetainedAudioOptions',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_USER_SHORTCUT',
    'SDTAudio', 'SPXRO_SML', 'SVF_None', 'DISPID_SLPType',
    'SRADynamic', 'DISPID_SDKSetLongValue', 'SpeechRuleState',
    'DISPID_SOTCId', 'SP_VISEME_15', 'eLEXTYPE_PRIVATE1',
    'SPEI_SR_PRIVATE', 'DISPID_SVSVisemeId', 'DISPID_SLWs_NewEnum',
    'DISPID_SADefaultFormat', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseInfo', 'eLEXTYPE_PRIVATE17',
    'DISPID_SLPsCount', 'DISPID_SRGId', 'ISpeechObjectToken',
    ...
    'SAFT48kHz8BitMono', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SWFESamplesPerSec', 'SPINTERFERENCE_NOISE',
    'DISPID_SPARecoResult', 'SPINTERFERENCE_LATENCY_WARNING',
    'Speech_Default_Weight', 'DISPID_SPERequiredConfidence',
    'SDA_Consume_Leading_Spaces', 'SRTAutopause', 'SECFIgnoreCase',
    'SREBookmark', 'SAFTADPCM_44kHzStereo', 'SGLexical',
    'DISPID_SGRName', 'DISPID_SPIGrammarId',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSpeakStream',
    'SpeechVoicePriority', 'SAFTNoAssignedFormat', 'SRSEDone',
    'SGDisplay', 'SSTTDictation', 'eLEXTYPE_PRIVATE6',
    'DISPID_SASCurrentSeekPosition', 'STCAll', 'SPPS_Verb',
    'ISpeechVoice', 'SPEI_MIN_TTS', 'DISPID_SDKDeleteKey',
    'SDA_One_Trailing_Space', 'SPPS_Function', 'SPPS_Interjection',
    'DISPID_SBSWrite', 'SpeechStreamFileMode', 'SRTExtendableParse',
    'STSF_FlagCreate', 'STSF_AppData', 'ISpeechRecoResult2',
    'eLEXTYPE_PRIVATE2', 'SPWT_PRONUNCIATION', 'SPINTERFERENCE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVDisplayUI',
    ...
    'SAFT24kHz8BitMono', 'SAFT11kHz16BitMono', 'SREAllEvents',
    'ISpeechMemoryStream', 'ISpeechPhraseAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRDisplayUI',
    'SRAImport', 'DISPID_SBSSeek', 'DISPID_SRGCmdLoadFromResource',
    'SpeechLexiconType', 'DISPID_SpeechPhraseReplacements',
    'ISpObjectToken', 'WAVEFORMATEX', 'DISPID_SGRSAddRuleTransition',
    'SFTInput', 'DISPID_SPRsItem', 'SPGRAMMARSTATE',
    'eLEXTYPE_PRIVATE3', 'SPLO_DYNAMIC', 'SAFTCCITT_uLaw_22kHzStereo',
    'eWORDTYPE_DELETED', 'ISpXMLRecoResult',
    'DISPID_SpeechBaseStream', 'Speech_Max_Pron_Length',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPIAudioSizeBytes',
    'Speech_StreamPos_Asap', 'DISPID_SDKOpenKey',
    'ISpeechAudioStatus', 'STCInprocHandler', 'SpeechBookmarkOptions',
    'SAFTGSM610_22kHzMono', 'tagSTATSTG', 'SPFM_NUM_MODES',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCSetAdaptationData',
    'DISPID_SASetState', 'DISPID_SpeechPhraseAlternate',
    'SVSFIsFilename', 'SGSEnabled', 'SAFTCCITT_uLaw_11kHzMono',
    'SASPause', 'DISPID_SpeechObjectToken', 'DISPID_SVSkip',
    'DISPID_SRRDiscardResultInfo', 'SP_VISEME_13',
    'DISPID_SpeechAudioFormat', 'ISpeechMMSysAudio',
    'SpeechCategoryAudioIn', 'DISPID_SVEVoiceChange',
    '__MIDL_IWinTypes_0009', 'DISPID_SLGetPronunciations',
    'SPRECOCONTEXTSTATUS', 'SAFT11kHz16BitStereo', 'STCLocalServer',
    'SpeechAudioFormatGUIDWave', 'ISpeechTextSelectionInformation',
    'SPVPRI_NORMAL', 'SPAS_STOP', 'SPCS_ENABLED', 'SPEI_RECOGNITION',
    'ISpeechResourceLoader', 'ISpeechVoiceStatus',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPEAudioSizeTime',
    'SPRS_INACTIVE', 'DISPID_SLPSymbolic', 'SPEI_RESERVED5',
    'DISPID_SVStatus', 'DISPID_SAStatus', 'SPAUDIOOPTIONS',
    'STCRemoteServer', 'SpeechPropertyResourceUsage', 'SPSLMA',
    'SpMemoryStream', 'eLEXTYPE_PRIVATE8', 'SPINTERFERENCE_NOSIGNAL',
    'Speech_StreamPos_RealTime', 'DISPID_SRCEPropertyNumberChange',
    'SDKLDefaultLocation', 'SPEI_ADAPTATION', 'SRERecoOtherContext',
    'SPAUDIOBUFFERINFO', 'SPPS_SuppressWord',
    'DISPID_SRCEEnginePrivate', 'DISPID_SWFEExtraData', 'SPSModifier',
    'SRTReSent', 'SPEI_SOUND_START', 'SECFNoSpecialChars',
    'DISPID_SDKGetStringValue', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPAPhraseInfo', 'ISpeechLexiconWord',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SGRSTText',
    'DISPID_SAFGuid', 'DISPID_SDKEnumValues',
    'SPINTERFERENCE_TOOQUIET', 'SDTDisplayText',
    'SpeechRegistryUserRoot', 'SpeechCategoryPhoneConverters',
    'SGRSTTRule', 'DISPID_SRCERequestUI',
    'SpeechRecoProfileProperties', 'SpeechRecognitionType',
    'DISPID_SVAlertBoundary', 'SPWF_SRENGINE', 'SpCustomStream',
    'SAFTADPCM_11kHzMono', 'SPWT_DISPLAY', 'DISPID_SLPs_NewEnum',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPRFirstElement',
    'DISPID_SMSAMMHandle', 'SP_VISEME_11', 'SPEI_REQUEST_UI',
    'SpeechFormatType', 'DISPID_SPRules_NewEnum', 'eLEXTYPE_PRIVATE9',
    'DISPID_SAVolume', 'SP_VISEME_9', 'ISpProperties', 'SPRST_ACTIVE',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechFileStream', 'SLOStatic',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechEngineConfidence', 'SRESoundStart', 'SVPNormal',
    'DISPID_SOTCreateInstance', 'DISPID_SRRTStreamTime', 'SVEPrivate',
    'DISPID_SRGCmdLoadFromFile', 'SAFT16kHz16BitStereo', 'SPEVENT',
    'SGSDisabled', 'DISPID_SpeechPhraseElement',
    'DISPID_SRGDictationLoad', 'SpeechVoiceSkipTypeSentence',
    'ISpEventSink', 'SVPOver', 'DISPID_SGRAttributes',
    'SSFMCreateForWrite', 'DISPID_SPRuleChildren', 'DISPID_SLWLangId',
    'DISPID_SPIStartTime', 'eLEXTYPE_USER', 'DISPID_SOTCGetDataKey',
    'DISPID_SVSInputSentencePosition', 'SPSTREAMFORMATTYPE',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGRecoContext',
    'SVSFDefault', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SLPPartOfSpeech', 'SPSUnknown', 'SVP_2',
    'eLEXTYPE_PRIVATE5', 'eLEXTYPE_PRIVATE10', 'SLTUser',
    'DISPID_SPIEnginePrivateData', 'SREStreamEnd',
    'SpeechDataKeyLocation', 'SRSActive', 'DISPID_SVSPhonemeId',
    'SDTLexicalForm'
]

_check_version('1.1.14', 1639554577.999447)
